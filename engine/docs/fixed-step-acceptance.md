...
Strict preflight rejected eight incorrect offset calculations in the historical preparation packet before any compiler command. The corrected inventory comes from original PE relocation records and four live-disassembly call positions; all addresses, extents and operand counts were already correct. No matcher, original bytes or acceptance rule changed.
