...
| material_state | [material_destroy](../src/material_destroy.c) | 0x0047B55C | c | unverified | 53 / 16 |
| material_state | [material_install_palette](../src/material_install_palette.c) | 0x0047B993 | c | unverified | 42 / 12 |
| material_state | [material_invalidate_cache](../src/material_invalidate_cache.c) | 0x0047BB8D | c | unverified | 144 / 0 |

Registered functions: **153**. Last recorded matches with unchanged definitions: **150**.
...
Latest build: '20260913-212841-5e5ff57d', source commit '9f0a705b02464c22b82db0b24e001e2afa6d5168'.
History contains 50 verified build records.
