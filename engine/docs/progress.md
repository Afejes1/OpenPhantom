...
| sprite_resources | [sprite_acquire](../src/sprite_acquire.c) | 0x00429540 | c | unverified | 64 / 12 |

Registered functions: **110**. Last recorded matches with unchanged definitions: **109**.
