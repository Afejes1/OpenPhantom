...
| pzip-stream | [stream_open](../src/stream_open.c) | 0x00470C66 | c | unverified | 86 / 4 |
| pzip-stream | [pack_stream_open](../src/pack_stream_open.c) | 0x004706E5 | c | unverified | 161 / 8 |
| pzip-stream | [stream_close](../src/stream_close.c) | 0x00470CBC | c | unverified | 44 / 4 |

Registered functions: **293**. Last recorded matches with unchanged definitions: **290**.
...
Latest build: '20260914-120637-0d3e87cd', source commit '70044c1afcdf54b8445e1439e079cdaaf0ca866d'.
History contains 75 verified build records.
