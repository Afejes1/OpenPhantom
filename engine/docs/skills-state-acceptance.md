...
The retained matrices verify all216 bytes and both independent globals for8*12^3 cases per function, including INT_MIN and INT_MAX. All124,416 focused assertions pass without executing undefined signed arithmetic. No original game execution, byte exclusions or warning waivers. Whole-executable placement remains unfinished.
