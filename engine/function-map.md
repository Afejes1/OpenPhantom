...
| 0x004056C0 | FUN_004056c0 | gather_legacy_cell_surfaces | HIGH behavior; compilation unverified | Gather linked/discovered group surfaces, perform slab culling and emit inline/reference records | Complete 809-byte body and seven NOPs, two world traversal callers, bucket/culler/emitter callees and group/queue/seen state; docs/legacy-cell-evidence.md |
