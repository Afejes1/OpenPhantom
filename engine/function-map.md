...
| 0x00404180 | FUN_00404180 | initialize_legacy_scan_frame | HIGH purpose; byte comparison pending | Copy active camera state, derive directional scan limits, build offsets and reset scan sentinels | Complete static body and seven padding bytes; world-render caller; trigonometric/line/scan-step callees; camera and scan globals; corrected VC5 C candidate passes 6,548 focused assertions; research/campaign-001-frame-setup/README.md |
