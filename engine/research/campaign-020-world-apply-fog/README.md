...
The original VC5 RTM compiler produces a complete 230-byte match
with 10 verified address operands and zero differing bytes.
The independently reviewed locked-Docker fixture passes 198 checks.
