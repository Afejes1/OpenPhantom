# Periodic music service

The independently authored C implementation matches the **complete 59-byte
...
Import slots are represented by authored function pointers in fixtures; actual DLLs, timing, concurrency and signed counter overflow are not tested.
...
```powershell
python engine/research/campaign-001/verify.py --case engine/research/campaign-005-music-periodic --runner native --reference C:/Dev/Ghidra/projects/TPM/WMAIN.EXE
python engine/research/campaign-001/verify.py --case engine/research/campaign-005-music-periodic --runner docker --reference C:/Dev/Ghidra/projects/TPM/WMAIN.EXE --behavior --expect-report <native-report-path> --native-listing-fallback
```
