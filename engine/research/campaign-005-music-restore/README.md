# Read cached music IDs

The independently authored C implementation matches the **complete 46-byte
original interval**, with **2 verified address operands and zero differing
bytes** after address resolution. All **33 focused assertions pass**.
...
The read callback is authored; no actual save file, playback replay or device restore is executed.
...
```powershell
python engine/research/campaign-001/verify.py --case engine/research/campaign-005-music-restore --runner native --reference C:/Dev/Ghidra/projects/TPM/WMAIN.EXE
python engine/research/campaign-001/verify.py --case engine/research/campaign-005-music-restore --runner docker --reference C:/Dev/Ghidra/projects/TPM/WMAIN.EXE --behavior --expect-report <native-report-path> --native-listing-fallback
```
