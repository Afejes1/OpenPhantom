...
The original VC5 RTM compiler produces a complete 112-byte match
with 3 verified address operands and zero differing bytes.
The independently reviewed locked-Docker fixture passes 1527 checks.
