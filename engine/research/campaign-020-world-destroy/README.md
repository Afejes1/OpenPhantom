...
The original VC5 RTM compiler produces a complete 192-byte match
with 8 verified address operands and zero differing bytes.
The independently reviewed locked-Docker fixture passes 246 checks.
