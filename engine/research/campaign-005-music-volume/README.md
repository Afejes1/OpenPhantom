...
The independently authored C implementation matches the **complete 11-byte
...
Signaling NaN exceptions and alternate FPU control environments are not tested.
...
```powershell
python engine/research/campaign-001/verify.py --case engine/research/campaign-005-music-volume --runner native --reference C:/Dev/Ghidra/projects/TPM/WMAIN.EXE
python engine/research/campaign-001/verify.py --case engine/research/campaign-005-music-volume --runner docker --reference C:/Dev/Ghidra/projects/TPM/WMAIN.EXE --behavior --expect-report <native-report-path> --native-listing-fallback
```
