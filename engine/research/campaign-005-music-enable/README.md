...
bytes** after address resolution. All **30 focused assertions pass**.
...
Fixtures stub configuration/init/playback callbacks; passing them does not prove actual device initialization or playback.
...
```powershell
python engine/research/campaign-001/verify.py --case engine/research/campaign-005-music-enable --runner native --reference C:/Dev/Ghidra/projects/TPM/WMAIN.EXE
python engine/research/campaign-001/verify.py --case engine/research/campaign-005-music-enable --runner docker --reference C:/Dev/Ghidra/projects/TPM/WMAIN.EXE --behavior --expect-report <native-report-path> --native-listing-fallback
```
