...
Complete original interval0x00470C66 through0x00470CBC: 86bytes, including RET, no tail. Cdecl one-pointer parameter; open routines return allocated state or null, plain close returns captured file word after release. Existing allocator/release/fclose aliases are retained.
