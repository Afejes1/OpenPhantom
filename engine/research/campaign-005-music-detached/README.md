# Music attachment status

The independently authored C implementation matches the **complete 17-byte
original interval**, with **1 verified address operands and zero differing
bytes** after address resolution. All **12 focused assertions pass**.
...
Focused integer input coverage; no integrated audio device test.
...
```powershell
python engine/research/campaign-001/verify.py --case engine/research/campaign-005-music-detached --runner native --reference C:/Dev/Ghidra/projects/TPM/WMAIN.EXE
python engine/research/campaign-001/verify.py --case engine/research/campaign-005-music-detached --runner docker --reference C:/Dev/Ghidra/projects/TPM/WMAIN.EXE --behavior --expect-report <native-report-path> --native-listing-fallback
```
