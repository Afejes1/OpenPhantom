...
extern unsigned int op_task_count, op_task_cursor;
extern float op_task_target, op_task_simulation;
extern int op_task_sentinel;
extern OP_TASK_RECORD *op_task_current;
int op_task_module_proc(int);
OP_TASK_RECORD *op_task_register(OP_TASK_UPDATE);
unsigned int op_task_run(OP_TASK_RECORD *);
void op_task_alloc_state(unsigned int, void **);
