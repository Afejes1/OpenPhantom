#ifndef OP_CAMPAIGN036_API_H
#define OP_CAMPAIGN036_API_H
#include <stddef.h>
...
void *op_acquire_sprite(const char *);
...
int op_font_set_backdrop(const char *name, float width, float height);
