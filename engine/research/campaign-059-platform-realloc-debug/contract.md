# platform_realloc_debug

Cdecl wrapper preserves argument words and returned pointer identity; free is void. Owned/null pointers and all unsigned size patterns are observed without actual allocation or dereferencing fabricated storage. Identity returns its input with no backend call.
