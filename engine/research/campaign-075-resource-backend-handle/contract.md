# resource_backend_handle

Full original span 0x00473137 to 0x00473156, 31 bytes with no tail. All relevant address operands are explicitly bound in target.json.
