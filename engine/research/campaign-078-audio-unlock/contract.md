...
Full interval 0x00497039 to0x0049706B, 50 bytes including every original instruction; no tail. Verified by static Ghidra disassembly and next function. Latest contributor manifest marks this address not_done.
