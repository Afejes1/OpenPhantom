...
Complete original span 0x00495CBF to0x00495CE4, 37 bytes, no tail. Latest manifest not_done and no earlier source campaign. Cdecl wrappers, stdcall callbacks, all address bindings listed in target.json.
