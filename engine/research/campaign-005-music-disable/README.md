...
The independently authored C implementation matches the **complete 47-byte
original interval**, with **7 verified address operands and zero differing
bytes** after address resolution. All **18 focused assertions pass**.
...
Authored callbacks only; persistent options and audio shutdown integration are not executed.
...
```powershell
python engine/research/campaign-001/verify.py --case engine/research/campaign-005-music-disable --runner native --reference C:/Dev/Ghidra/projects/TPM/WMAIN.EXE
python engine/research/campaign-001/verify.py --case engine/research/campaign-005-music-disable --runner docker --reference C:/Dev/Ghidra/projects/TPM/WMAIN.EXE --behavior --expect-report <native-report-path> --native-listing-fallback
```
