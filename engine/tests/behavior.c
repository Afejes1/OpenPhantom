...
#include "audio_get_spatial_behavior.c"
...
#include "frame_pacing_behavior.c"
...
int main(void)
{
    ...
    failures += op_test_audio_get_spatial();
    ...
    failures += op_test_pace_frame_clock();
