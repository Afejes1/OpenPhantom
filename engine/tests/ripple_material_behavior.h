...
void *lc_ripple_material_op_sprite_get_material(void *sprite)
{
    int lc_ripple_material_n = lc_ripple_material_stage++;
    lc_ripple_material_CHECK(lc_ripple_material_n == 2 || lc_ripple_material_n == 3);
    lc_ripple_material_CHECK(
        sprite == (lc_ripple_material_n == 2 ? lc_ripple_material_alpha_result : lc_ripple_material_color_result));
    lc_ripple_material_verify_state();
    lc_ripple_material_owned[7][lc_ripple_material_n] = 0x39;
    lc_ripple_material_expected_owned[7][lc_ripple_material_n] = 0x39;
    return lc_ripple_material_n == 2 ? lc_ripple_material_alpha_material : lc_ripple_material_color_material;
}
void *lc_ripple_material_op_compose_materials(void *lc_ripple_material_color, void *lc_ripple_material_alpha)
{
    lc_ripple_material_CHECK(lc_ripple_material_stage++ == 4);
...
static void lc_ripple_material_run_case(int lc_ripple_material_index, int cached, int mode)
{
    ...
    lc_ripple_material_color_result = lc_ripple_material_profile & 1 ? 0 : lc_ripple_material_owned[0];
    lc_ripple_material_alpha_result =
        lc_ripple_material_profile & 2
            ? 0
            : (lc_ripple_material_profile == 16 ? lc_ripple_material_owned[0] : lc_ripple_material_owned[1]);
    lc_ripple_material_color_material = lc_ripple_material_profile & 4 ? 0 : lc_ripple_material_owned[2];
    lc_ripple_material_alpha_material =
        lc_ripple_material_profile & 8
            ? 0
            : (lc_ripple_material_profile == 16 ? lc_ripple_material_owned[2] : lc_ripple_material_owned[3]);
