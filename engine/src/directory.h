#ifndef OP_DIRECTORY_H
#define OP_DIRECTORY_H
#include <stddef.h>
...
typedef char op_directory_metadata_offsets[(offsetof(OP_FIND_DATA,time_written)==12 && offsetof(OP_FIND_DATA,size)==16 && offsetof(OP_DIRECTORY_ENTRY,is_directory)==260 && offsetof(OP_DIRECTORY_ENTRY,time_written)==264)?1:-1];
#endif
